...
public class TitleAPI implements Listener {
    ...
    public static void sendActionbar(Player p, String actionbar){
        p.spigot().sendMessage(ChatMessageType.ACTION_BAR, (new TextComponent(common.color(actionbar))));

    }

    public static void sendTitle(Player player, Integer fadeIn, Integer stay, Integer fadeOut, String title, String subtitle) {
        TitleEvent titleSendEvent = new TitleEvent(player, title, subtitle);
    ...
    public static void sendTabTitle(Player player, String header, String footer) {
        ...
        TabTitleEvent tabTitleSendEvent = new TabTitleEvent(player, header, footer);
