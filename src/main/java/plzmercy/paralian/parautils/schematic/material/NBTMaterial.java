...
import plzmercy.paralian.parautils.schematic.block.NBTChestBlock;
import plzmercy.paralian.parautils.schematic.block.NBTSignBlock;
...
public enum NBTMaterial {
    ...
    public static NBTMaterial fromTag(NBTTagCompound nbtTagCompound) {
        try {
            return NBTMaterial.valueOf(nbtTagCompound.l("Id").
                    replace("minecraft:", "").
                    toUpperCase());
